          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 2.v),
                Text(
                  "ID: ${authController.profile.value.user!.id!.toString()}",
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  authController.profile.value.user!.rating!
                                      .toString(),
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  authController.profile.value.user!.level!
                                      .toString(),
                ...
                Padding(
                  ...
                  child: CustomTextFormField(
                    ...
                    hintText: authController.profile.value.user!.totalWins!,
                    textInputAction: TextInputAction.done,
                    prefix: Container(
                      margin: EdgeInsets.fromLTRB(30.h, 3.v, 14.h, 6.v),
                      child: CustomImageView(
                    ...
                    borderDecoration: TextFormFieldStyleHelper.fillGrayTL3,
                ...
                CustomElevatedButton(
                  height: 33.v,
                  width: 122.h,
                  text: authController.profile.value.user!.totalCoins!,
                  leftIcon: Container(
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: ShapeDecoration(
                ...
                shape: RoundedRectangleBorder(
                  side: BorderSide(width: 3, color: Color(0xFFF4B30B)),
